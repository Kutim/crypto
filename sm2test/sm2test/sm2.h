 ...
 * other errcode : operation failed
 */
SM2_DLL_API _declspec(dllexport) int GM_SM2Encrypt(unsigned char * encData, unsigned long * ulEncDataLen, unsigned char * plain, unsigned long plainLen,
